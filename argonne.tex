...
Next-generation light sources will enable exciting new opportunities for 
exploration and discovery; however, they will create new challenges for
those that operate and use these instruments. Presently, researchers are
able to manage data in an ad hoc manner using the tools and services available
to them; as data acquisition rates and sizes increase, it is likely that
progress will be dependent on the finite human capacity available. 
We have described here the need to outsource and automate a broad
spectrum of data lifecycle operations with the aim to reduce the burden 
on researchers by providing cost-effective, scalable, and reliable implementations
of these processes.

We presented three specific areas in which automation and outsourcing 
can immediately provide enormous benefits to scientists: 
data distribution, lifecycle automation, and transformation.
In the first, the Globus data publication platform provides
a suite of services for making data accessible, discoverable, 
and citable.  The MDF demonstrates how this platform can be used
to establish an ecosystem of high quality materials datasets
for community use. 
In the second, Globus Automate provides a flexible automation 
model that can be used to create arbitrary automation flows
that manage data from acquisition, through sharing, analysis, 
and publication. 
Finally, the Data and Learning Hub for science (DLHub) 
enables the publication and on-demand application of machine learning models 
as part of data capture and analysis. 
Collectively, these capabilities allow light source scientists
to outsource and automate a variety of end-to-end workflows, thereby
enabling scientists to decrease the time and effort associated with
